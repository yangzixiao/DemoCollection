...
import com.permissionx.guolindev.callback.ForwardToSettingsRefusedCallback;
...
public class PermissionBuilder {
     ...
     * 当去设置页面对话框点击取消时
     */
    ForwardToSettingsRefusedCallback forwardToSettingsRefusedCallback;
     ...
     * @return PermissionBuilder itself.
     */
    public PermissionBuilder onForwardToSettingsRefused(ForwardToSettingsRefusedCallback callback) {
        forwardToSettingsRefusedCallback = callback;
        return this;
    }
        ...
        if (negativeButton != null) {
            ...
            negativeButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialog.dismiss();
                    //拒绝去设置页面开启回调
                    if (forwardToSettingsRefusedCallback != null && !showReasonOrGoSettings) {
                        forwardToSettingsRefusedCallback.onForwardToSettingsRefused(permissions);
                    }
                    chainTask.finish();
                }
            });
